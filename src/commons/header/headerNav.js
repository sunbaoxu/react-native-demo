...
export default class NavigatorBar extends Component{
   ...
   render(){
        //状态栏
       let statusBar=<StatusBar barStyle='light-content' translucent={true} hidden={false} animated={true} {...this.props.statusBar} />;
        return(
            <View>
                {statusBar}
                <View style={cs.navgigatorBar}>
                    ...
                    <View style={cs.title}>
                        <Text style={cs.col}>{this.props.title}</Text>
                    </View>
